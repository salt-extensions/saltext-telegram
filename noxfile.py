...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=src/saltext/telegram/*",
            "--include=tests/*",
        )
        try:
            session.run("coverage", "report", "--show-missing", "--include=src/saltext/telegram/*")
            ...
            #    "--include=src/saltext/telegram/*,tests/*"
            # )
        finally:
