# Salt Extension for Telegram

Salt Extension for interacting with Telegram
...
The saltext-telegram project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-telegram.git
...
* Writing blog posts
* Sharing your experiences using Salt + Telegram
  on social media
...
[issues]: https://github.com/salt-extensions/saltext-telegram/issues
[PRs]: https://github.com/salt-extensions/saltext-telegram/pulls
[discussions]: https://github.com/salt-extensions/saltext-telegram/discussions
[comments]: https://conventionalcomments.org/
[docs]: https://salt-extensions.github.io/saltext-telegram/
